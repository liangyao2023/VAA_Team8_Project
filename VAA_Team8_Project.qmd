...
| Pages        | Contents                                                                |
|------------|------------------------------------------------------------|
| Introduction | To introduce the background and objective of this project.              |
| Proposal     | To introduce the dataset and to propose the methodologies of analysing. |
| Analysis     | To display the analyze process and conclusions.                         |
| Shiny APP    | To show the interactive results of analysis.                            |
